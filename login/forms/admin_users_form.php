    ...
    <div class="col-md-4">
        <div class="radio">
            <label>
                ...
                <input type="radio" name="admin_type" value="super" required="" <?php echo ($edit && $admin_account['admin_type'] =='super') ? "checked": "" ; ?>/><b> SUPER ADMIN</b>
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="admin_type" value="pharmacist" required="" <?php echo ($edit && $admin_account['admin_type'] =='pharmacist') ? "checked": "" ; ?>/><b>PHARMACIST</b>
            </label>
        </div>
    </div>
</div>
