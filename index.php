...
<p class="description">Please type your drug number to verify drug only if your details are present in our database or else report your organization.</p>
</div>
<div class="box" data-aos="zoom-in" data-aos-delay="200">
<div class="icon" style="background:white;">
<span class="iconify" data-icon="ion:checkmark-done" data-inline="false" data-width="50" data-height="50" style="color: #f058dc;"></span>
...
<p class="description">Please report the drug by entering the necessary information.</p>
</div>
</div>
